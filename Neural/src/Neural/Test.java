...
public class Test extends JFrame {
		...
		protected void paintComponent(Graphics g) {
			...
			for (int x = 0; x < getWidth(); x++)
				for (int y = 0; y < getHeight(); y++) {
					 ...
					 * (wynik[0]>0.5)?0:(int)Math.round((0.5-wynik[0])*510), 255));
					 */
	...
	public Test(String string) {
		...
		/*
		 * //1 warstwa 1 neuron int []tab=new int [1]; tab[0]=1; siec=new Siec(2,1,tab);
		 */
		...
		/*
		 * //2 warstwy int [] tab=new int [2]; tab[0]=10; tab[1]=1; siec=new
		 * Siec(2,2,tab);
		 */
		setVisible(true);
	}
