...
public class PanelRysujacy extends JPanel implements MouseListener, MouseMotionListener {
	// Współrzędne kursora
	...
	// Wyczyść obraz i ustaw współrzędne kursora poza obszar
	public void clear() {
		wspolX = -1;
		wspolY = -1;
		obraz = new BufferedImage(WIDTH, HEIGHT, BufferedImage.TYPE_INT_ARGB);
	...
	// Zwraca skalowany obraz rysowany w postaci macierzy boolean w postaci liczby
	// kolumn i wierszy oraz prostokąta określającego granice obrazu
